...
import postImg from "../assets/img/post_img.png";
...
function PostDetail() {
  return (
    <div className='flex-col'>
      ...
      <div className='post_dt_title'>Post Title Here...</div>
      <div className='flex-row author-loc'>
        <div className='post_dt_author'>Author</div>
        <div className='post_dt_loc'>Location</div>
      </div>
      <div className='post_dt_content'>Labore sunt veniam amet est. Minim nisi dolor eu ad incididunt cillum elit ex ut. Dolore exercitation nulla tempor consequat aliquip occaecat. Nisi id ipsum irure aute. Deserunt sit aute irure quis nulla eu consequat fugiat Lorem sunt magna et consequat labore. Laboris incididunt id Lorem est duis deserunt nisi dolore eiusmod culpa exercitation consectetur.
